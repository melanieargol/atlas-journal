...
export function ResultsCard({ analysis, mode }: ResultsCardProps) {
  return (
    <section className="panel results-panel">
      <div className="section-head">
        ...
        {mode ? <div className="mode-badge">{mode === "mock" ? "Mock analysis" : "OpenAI analysis"}</div> : null}
      </div>

      <div className="results-grid">
        <article className="detail-panel detail-panel-strong">
        ...
        <article className="detail-panel">
          <p className="section-label">Shift</p>
          <p>
            Started <strong>{analysis.emotional_shift.start_state}</strong> and ended{" "}
            <strong>{analysis.emotional_shift.end_state}</strong>.
          </p>
          <p className="muted-text">Direction: {analysis.emotional_shift.direction}</p>
